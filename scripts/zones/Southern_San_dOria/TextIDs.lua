...
-- General Texts
   ITEM_CANNOT_BE_OBTAINED = 6412; -- Come back after sorting your inventory.
FULL_INVENTORY_AFTER_TRADE = 6414; -- Try trading again after sorting your inventory.
       ...
       NOT_HAVE_ENOUGH_GIL = 6420; -- You do not have enough gil.
           LEATHER_SUPPORT = 6713; -- Your ?Multiple Choice (Parameter 1)?[fishing/woodworking/smithing/goldsmithing/clothcraft/leatherworking/bonecraft/alchemy/cooking] skills went up ?Multiple Choice (Parameter 2)?[a little/ever so slightly/ever so slightly].?Prompt?

-- Conquest System
CONQUEST =  8419; -- You've earned conquest points!
...
PLAYERS_HAVE_NOT_REACHED_LEVEL = 7351; -- Players who have not reached level <<<Numeric Parameter 0>>> are prohibited from entering Dynamis.
  UNUSUAL_ARRANGEMENT_BRANCHES = 7361; -- There is an unusual arrangement of branches here.

-- Quest Dialogs
      UNLOCK_PALADIN = 7944; -- You can now become a paladin!
       FLYER_REFUSED = 8115; -- Your flyer is refused.
      FLYER_ACCEPTED = 8764; -- The flyer is accepted.
       FLYER_ALREADY = 8765; -- This person already has a flyer.

-- Harvest Festival
      TRICK_OR_TREAT = 7291; -- Trick or treat...
     THANK_YOU_TREAT = 7292; -- And now for your treat...
...
ITEM_DELIVERY_DIALOG = 8344; -- Parcels delivered to rooms anywhere in Vana'diel!
     ...
     BLENDARE_DIALOG = 8028; -- Wait! If I had magic, maybe I could keep my brother's hands off my sweets...

    BLENDARE_MESSAGE = 8766; -- Blendare looks over curiously for a moment.
       ROSEL_MESSAGE = 8767; -- Rosel looks over curiously for a moment.
       MAUGIE_DIALOG = 8768; -- A magic shop, eh? Hmm... A little magic could go a long way for making a leisurely retirement! Ho ho ho!
      MAUGIE_MESSAGE = 8769; -- Maugie looks over curiously for a moment.
      ADAUNEL_DIALOG = 8770; -- A magic shop? Maybe I'll check it out one of these days. Could help with my work, even...
     ADAUNEL_MESSAGE = 8771; -- Adaunel looks over curiously for a moment.
     LEUVERET_DIALOG = 8772; -- A magic shop? That'd be a fine place to peddle my wares. I smell a profit! I'll be up to my gills in gil, I will!
    LEUVERET_MESSAGE = 8773; -- Leuveret looks over curiously for a moment.

     PAUNELIE_DIALOG = 8244; -- I'm sorry, can I help you?

-- Shop Texts
      LUSIANE_SHOP_DIALOG = 7895; -- Hello! Let Taumila's handle all your sundry needs!
      OSTALIE_SHOP_DIALOG = 7896; -- Welcome, customer. Please have a look.

ASH_THADI_ENE_SHOP_DIALOG = 7917; -- Welcome to Helbort's Blades!

       SHILAH_SHOP_DIALOG = 8049; -- Welcome, weary traveler. Make yourself at home!

            CLETAE_DIALOG = 8135; -- Why, hello. All our skins are guild-approved.
   KUEH_IGUNAHMORI_DIALOG = 8136; -- Good day! We have lots in stock today.

FERDOULEMIONT_SHOP_DIALOG = 7895; -- Hello!
      AVELINE_SHOP_DIALOG = 8354; -- Welcome to Raimbroy's Grocery!
      BENAIGE_SHOP_DIALOG = 8355; -- Looking for something in particular?
 ...
 APAIREMANT_CLOSED_DIALOG = 8360; -- I'd love to import produce from Gustaberg, but the foreign powers in control there make me feel unsafe!
